...
import com.weslleyguedes.projetospring.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p6, p7, p8, p9, p10, p11));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "weslleyguedes.as@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "wesmut@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
